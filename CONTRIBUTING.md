...
Once your new feature is implemented and you tested that it works correctly, you must create a Pull Request to merge it to master. Before mergeing, this PR will be reviewed and approved (or rejected) by one of the repository owners (@hrivas23 or @itamayo) in order to check that it works correctly and there are no integration issues.
